...
router.put('/approve-welfare/:id', authPermissionEditor, logReimbursementUpdate('MEDICAL'), checkNullValue, bindUpdate, esign.preloadGeneralApprove, minio.putFile, esign.stamper, minio.getPublicFile, minio.deleteFile, esign.nornalize, reimbursementsGeneralController.update);
router.put('/disburse-welfare/:id', authPermissionEditor, logReimbursementUpdate('MEDICAL'), checkNullValue, bindUpdate, esign.preloadGeneralDisburse, minio.putFile, esign.stamper, minio.getPublicFile, minio.deleteFile, esign.acknowledgeDisburse, esign.nornalize, reimbursementsGeneralController.update)
// Delete Methods
