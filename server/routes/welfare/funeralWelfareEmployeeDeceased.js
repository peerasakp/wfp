...
router.put('/approve-welfare/:id', esign.preloadFuneralApprove, minio.putFile, esign.stamper, minio.getPublicFile, minio.deleteFile, esign.nornalize, reimbursementsEmployeeDeceasedController.update)
// Delete Methods
