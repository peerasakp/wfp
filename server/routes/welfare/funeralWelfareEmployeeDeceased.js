...
router.put('/approve-welfare/:id', authPermissionEditor, logReimbursementUpdate('FUNERAL_EMPLOYEE'), checkNullValue, bindUpdate, esign.preloadFuneralApprove, minio.putFile, esign.stamper, minio.getPublicFile, minio.deleteFile, esign.nornalize, reimbursementsEmployeeDeceasedController.update)
