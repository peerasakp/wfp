...
router.put('/disburse-welfare/:id', authPermissionEditor, logReimbursementUpdate('CHILDREN_EDUCATION'), checkNullValue, bindUpdate, esign.preloadEducationDisburse, minio.putFile, esign.stamper, minio.getPublicFile, minio.deleteFile, esign.acknowledgeDisburse, esign.nornalize, reimbursementChildrenEducationController.update)
